...
biasing_atom_ids = np.array([atom.index for atom in top.topology.atoms() if atom.residue.name != 'HOH'])
if BIASED:
...
# DEFINE INTEGRATOR
integrator = LangevinIntegrator(400 * unit.kelvin, 1 / unit.picosecond, 2 * unit.femtoseconds)
